...
<div class="w3-top">
  <div class="w3-bar w3-theme w3-top w3-left-align w3-large">
    ...
    <h4> <a href="<?php echo site_url('covid-19/madagascar-'.$contenue['idSubject']).'.html';?>" class="w3-bar-item w3-button w3-theme-l1"">Madagascar</a></h4>
...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-row w3-padding-64">
    ...
    <div class="w3-third w3-container">
      <p class="w3-border w3-padding-large w3-padding-32 w3-left"><img src="<?php echo site_url("assets/image/organique.jpg"); ?>" alt="remede covid"></p>
      <p class="w3-border w3-padding-large w3-padding-64 w3-right"><img src="<?php echo site_url("assets/image/test.jpg"); ?>" alt="test covid"></p>
    </div>
  </div>
</div>
  <footer id="myFooter">
